        ...
        >
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <div className="font-medium text-gray-800">{loan.amount_paid}</div>
                </div>
                <div>
                    <div className="text-sm text-gray-500">Due Date</div>
                    <div className="font-medium text-gray-800">{loan.due_date}</div>
                </div>
                <div>
                    <div className="text-sm text-gray-500">Next Payment</div>
                    <div className="font-medium text-gray-800">{loan.next_payment}</div>
                </div>
            </div>
            ...
            <div className="flex justify-between items-center mt-4">
                <div className="text-xs text-gray-500">Applied on {loan.application_date}</div>
