...
const Profile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    employment_status: user.employment_status || "N/A",
    occupation: user.occupation || "N/A",
    employer: user.employer || "N/A",
    income: `₦${user.income || '0'}`,
    bankAccount: user.account_number || "N/A",
    bank: user.bank || "N/A",
  ...
  const handleSaveProfile = async () => {
    ...
    const dataSent = {
      ...
      income: parseFloat(profileData.income.replace(/[^0-9.]/g, '')),
                ...
                {isEditing ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input type="text" id="bank" name="bank" value={profileData.bank} onChange={handleInputChange} className={getInputClasses()} />
                    </div>
                  </div>
                ) : (
                  <div className="space-y-1">
                    ...
                    <hr className="border-gray-200 my-1" />
                    <InfoItem icon={<CreditCard size={18} />} label="Bank" value={profileData.bank} />
                  </div>
                )}
              </motion.div>
            )}
